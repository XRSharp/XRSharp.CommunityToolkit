...
set /p PackageVersion="%ESC%[92mXRSharp.CommunityToolkit version:%ESC%[0m 0.1.8-private-"

set PackageVersion="0.1.8-private-%PackageVersion%"

set XRSharpVersion="0.1.8-preview-2024-07-03-083945-ec96f694"
